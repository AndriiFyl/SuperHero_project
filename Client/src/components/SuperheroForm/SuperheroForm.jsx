  ...
  return (
    <div>
      <form onSubmit={handleFormSubmit}>
        ...
        <div className={css.input_wrapper}>
          <label className={css.label} htmlFor="realName">
            Real Name
          </label>
          <input
            className={css.input}
        ...
        <div className={css.input_wrapper}>
          <label className={css.label} htmlFor="originDescription">
            Origin Description
          </label>
          <input
            className={css.input}
        ...
        <div className={css.input_wrapper}>
          <label className={css.label} htmlFor="catchPhrase">
            Catch Phrase
          </label>
          <input
            className={css.input}
          ...
          <div>
            {images.map((image) => (
              <div className={styles.imageBlock}>
                ...
                />
                <div
                  className={styles.deleteImageText}
